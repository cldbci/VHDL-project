...
HD_PWD='C:/Users/Claudia/Desktop/Proiect ED/Proiect ED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log reg_par.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source reg_par.tcl -notrace

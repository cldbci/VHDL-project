...
HD_PWD='C:/Users/Claudia/Desktop/Proiect ED/Proiect ED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reg_par.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reg_par.tcl

...
set_property IOSTANDARD LVCMOS33 [get_ports {bitin}] 

set_property PACKAGE_PIN T1 [get_ports {selectie}]                     

set_property IOSTANDARD LVCMOS33 [get_ports {selectie}] 

set_property PACKAGE_PIN U1 [get_ports {selectie_deplasare}]                     

set_property IOSTANDARD LVCMOS33 [get_ports {selectie_deplasare}] 
